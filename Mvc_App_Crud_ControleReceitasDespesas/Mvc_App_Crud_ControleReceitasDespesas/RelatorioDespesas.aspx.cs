...
namespace Mvc_App_Crud_ControleReceitasDespesas.Views.Shared
{
    public partial class RelatorioDespesas : System.Web.UI.Page
    {
        ...
        {          
            List<DespesasEmp> despesas = new List<DespesasEmp>();
            empresaEntities ee = new empresaEntities();
            despesas = ee.DespesasEmps.OrderBy(a => a.Categoria).ToList();//ler os dados.
          //  this.ReportViewer1.LocalReport.DataSources.Clear();
           // ReportViewer1.ProcessingMode = ProcessingMode.Local;
            var rptPath = Server.MapPath(@"./Reports/RelatorioDespesa.rdlc");
          //  var ds1 = ReportViewer1.LocalReport.GetDataSourceNames();   
            
           // ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource(ds1[0], despesas));
        ...
        public class DBHelper
        {
            ...
            internal void ExecuteDataTable()
            {
                throw new NotImplementedException();
            }

            internal void ExecuteDataTable(string v)
            {
                throw new NotImplementedException();
            }
